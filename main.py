...
def summarize(input_path, output_path):
    ...
    for file in files:
        ...
        chunk_size = int(os.getenv("CHUNK_LENGTH"))
        ...
        for chunk in chunks:
            ...
            magic_number = int(os.getenv("ALL_CHUNK_SUMMARY_TARGET_LENGTH"))
